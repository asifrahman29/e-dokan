...
@section('content')
    <div class="page-inner">
        ...
        <div class="row">
            @php
                $stats = [
                    ['color' => 'primary', 'icon' => 'users', 'category' => 'Visitors', 'count' => '1,294'],
                    ['color' => 'info', 'icon' => 'user-check', 'category' => 'Subscribers', 'count' => '1303'],
                    ['color' => 'secondary', 'icon' => 'luggage-cart', 'category' => 'Sales', 'count' => '$ 1,345'],
                    ['color' => 'success', 'icon' => 'check', 'category' => 'Orders', 'count' => '576'],
                ];
            @endphp
            @foreach ($stats as $stat)
                <x-admin.statscard :color="$stat['color']" :icon="$stat['icon']" :category="$stat['category']" :count="$stat['count']" />
            @endforeach
