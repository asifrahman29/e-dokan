    ...
    <div class="page-inner">
        ...
        <div>
            <div class="d-flex justify-content-between mt-3">
                <div>
                    <a href="{{ $invoice->previous }}"
                        class="btn px-5 {{ !$invoice->previous ? 'disabled btn-danger' : 'btn-primary' }}">Previous</a>
                    <a href="{{ $invoice->next }}"
                        class="btn px-5 {{ !$invoice->next ? 'disabled btn-danger' : 'btn-primary' }}">Next</a>
                </div>
                <div>
